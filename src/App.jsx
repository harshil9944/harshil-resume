  ...
  return (
    <div className="app">
      <main>
        ...
        <section className="section compact" id="projects">
          ...
          <div className="footer-section">
            ...
            <div className="social-links">
              ...
              <a href="https://www.harshilcpatel.site" target="_blank" rel="noreferrer" title="Website" className="social-icon">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="10"/><path d="M12 2a10 10 0 110 20 10 10 0 010-20zm0 1.5a8.5 8.5 0 100 17 8.5 8.5 0 000-17zm0 2a6.5 6.5 0 110 13 6.5 6.5 0 010-13z" fill="white" opacity="0" class="hide"/></svg>
              </a>
            </div>
          </div>
